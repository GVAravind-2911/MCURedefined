...
const CreateBlogPage: React.FC = () => {
	...
	useEffect(() => {
		const draft = localStorage.getItem("create-review-draft");
		if (draft) {
	...
	const handlePreview = () => {
		...
		localStorage.setItem("create-review-draft", JSON.stringify(blogData));
		router.push("/manage/reviews/create/preview");
	};
