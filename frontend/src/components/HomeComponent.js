    ...
    <div>
      ...
      <section className="home-join-us">
        <div className="home-content11">
          ...
          <img alt="image" src="/images/Timeline.png" className="home-image20" />
        </div>
      </section>
        ...
        <div className="home-row1">
          <div className="home-column">
            <div className="home-card09">
              <img alt="image" src="/images/AvengersLogo.png" className="home-image21" />
            </div>
          </div>
          <div className="home-column1">
            <div className="home-card10">
              <img alt="image" src="/images/GuardiansLogo.png" className="home-image22" />
            </div>
          </div>
        </div>
