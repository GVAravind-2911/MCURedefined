    ...
    <footer className="home-footer">
      ...
      <div className="footercontainer">
        <div className="bottomlogo">
          <img src="/images/FooterLogo.png" className="footerlogo" alt="Footer Logo" />
        </div>
        <div className="iop">
        ...
        <div className="home-socials1">
          ...
          <div className="footersocials">
            <a href="https://twitter.com/Mcu_Redefined" target="_blank" rel="noreferrer noopener">
              <img alt="Twitter Icon" src="/images/Icons/twitter.svg" className="imagetwitter" />
            </a>
            <a href="https://discord.com/invite/KwG9WBup" target="_blank" rel="noreferrer noopener">
              <img alt="Discord Icon" src="/images/Icons/discord.svg" className="imagediscord" />
            </a>
            <a href="https://www.instagram.com/mcu_redefined/" target="_blank" rel="noreferrer noopener">
              <img alt="Instagram Icon" src="/images/Icons/instagram.svg" className="imageinsta" />
            </a>
          </div>
        </div>
      </div>
