		...
		>
			<div className="flex justify-between items-start mb-4 max-md:flex-col max-md:gap-4 max-md:items-stretch">
				...
				<div className="flex flex-col items-end gap-1 text-right max-md:items-start max-md:text-left">
					...
					<div className="font-[BentonSansRegular] text-white/50 text-[0.8rem]">
				...
				{shouldShowSpoilerWarning() ? (
					...
					>
						...
						<div className="text-white/90">
							<h4 className="m-0 mb-2 font-[BentonSansBold] text-xl text-[#ffa500]">
								Spoiler Warning
							</h4>
							<p className="m-0 mb-6 text-base leading-normal">
								This topic contains spoilers for{" "}
								<strong>{topic.spoilerFor}</strong>
							</p>
					...
					<div
						className={
							spoilerRevealed ? "animate-[topicSpoilerReveal_0.8s_ease]" : ""
						}
					>
						{topic.content}
					</div>
