...
function OrderComponent() {
	...
	React.useEffect(() => {
		...
		axios.get("/send-data").then((response) => {
			...
			setContentDict(
				response.data[0]
					.concat(response.data[1], response.data[2])
					.sort((a, b) => (a.timelineid > b.timelineid ? 1 : -1)),
			);
					...
					<div className="contentFill fade-in">
						<div className="sort">
							<div className="sort-release">
								<button type="button" id="releasesort-active">
									<svg
							...
							<div className="sort-timeline">
								<button type="button" id="timelinesort" onClick={Timelinesort}>
									<svg
										className="w-6 h-6 text-gray-800 dark:text-white"
										aria-hidden="true"
										xmlns="http://www.w3.org/2000/svg"
									...
									<div className="phase1-projectcard">
										<div className="img-container">
											<img
												...
												alt="Phase 1 Project Poster"
												className="phase1-posters"
											/>
										</div>
								...
								>
									<div className="phase2-projectcard">
										<div className="img-container">
											<img
												src={project.posterpath}
												alt="Phase 2 Project Poster"
												className="phase2-posters"
											/>
										</div>
								...
								>
									<div className="phase3-projectcard">
										<div className="img-container">
											<img
												src={project.posterpath}
												alt="Phase 3 Project Poster"
												className="phase3-posters"
											/>
										</div>
