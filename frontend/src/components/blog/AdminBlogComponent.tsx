...
const AdminBlogComponent: React.FC<AdminBlogComponentProps> = ({
  ...
  const {
    ...
    activeFilters,
    fetchBlogs,initialLoadComplete, isSearchFocused
  } = useBlogSearch({
    initialBlogs,
    initialTotalPages,
    apiUrl,
  ...
  }, [blogToDelete, apiUrl, currentPage, fetchBlogs, searchQuery, selectedTags, selectedAuthor, authToken]);
  ...
  return (
    <div className="blogs-container" ref={containerRef}>
      ...
      <dialog className="delete-confirmation-dialog" ref={dialogRef}>
        ...
        <p>Are you sure you want to delete <span className="delete-blog-title">{blogToDelete?.title}</span>?</p>
