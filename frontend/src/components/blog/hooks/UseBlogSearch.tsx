...
const useBlogSearch = ({
  ...
  }, [currentPage, searchQuery, selectedTags, selectedAuthor, path, blogContext.totalPages, containerRef, cachedPages, fetchBlogs, blogContext]);
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: <explanation>
    ...
    const matchesServer = query === "" && tags.length === 0 && author === "" && page === 1;
    if (!matchesServer) {
      fetchBlogs(page, query, tags, author);
    }
