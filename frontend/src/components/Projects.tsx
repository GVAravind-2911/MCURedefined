      ...
      <div className="project-hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-description">
            Explore the Marvel Cinematic Universe films and shows across different phases.
            From the genesis of Iron Man to the latest adventures in the multiverse saga.
          </p>
        </div>
      </div>
                  ...
                  >
                    <div className="project-poster-container">
                      ...
                      <div className="poster-overlay">
                        <div className="project-phase-badge">Phase {project.phase}</div>
                      </div>
                    </div>
