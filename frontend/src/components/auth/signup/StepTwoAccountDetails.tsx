export default function StepTwoAccountDetails({
	...
	return (
		<form onSubmit={handleSubmit} className="flex flex-col gap-5 relative z-1">
			<h2 className="text-center text-2xl font-bold text-white mb-6 uppercase tracking-wide [text-shadow:2px_2px_4px_rgba(0,0,0,0.5)]">Account Details</h2>
			...
			<div className="flex flex-col gap-2">
				<label htmlFor="username" className="text-sm text-white font-medium font-[BentonSansRegular,Arial,sans-serif]">Username</label>
				<input
					id="username"
					name="username"
					type="text"
