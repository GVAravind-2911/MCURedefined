    ...
    <header className={`main-header ${isScrolled ? "scrolled" : ""}`}>
          ...
          {session ? (
            <div className="user-dropdown">
              ...
              >
                ...
                <span className="user-name user-name-desktop">{session.user?.name}</span>
                <svg
      ...
      <div className={`mobile-menu ${isMobileMenuOpen ? "active" : ""}`}>
        ...
        <nav className="mobile-nav">
          ...
          <Link href="/reviews" className="mobile-nav-link" onClick={closeMobileMenu}>Reviews</Link>
          <Link href="/blogs" className="mobile-nav-link" onClick={closeMobileMenu}>Blog</Link>
          <Link href="/release-slate" className="mobile-nav-link" onClick={closeMobileMenu}>Release Slate</Link>
          <Link href="/collaborate" className="mobile-nav-link" onClick={closeMobileMenu}>Collaborate</Link>

          {!session && (
            <Link href="/auth" className="mobile-nav-link mobile-signin" onClick={closeMobileMenu}>
              Sign In
            </Link>
          )}
        </nav>
