  ...
  return (
    <div>
      <section className="home-hero">
        ...
        <img
          alt="image"
          src="../static/img/marvel/marvel-class-photo-1920x1080-1500w.jpg"
            ...
            <div className="home-main">
              <div className="home-content01">
                ...
                <p className="home-description2">
                  Thunderbolts, Blade, Wonder-Man Have halted Production due
                  to the WGA Strike. Deadpool 3, Captain America: New World
                  Order are in production.
                </p>
              </div>
              <a href="/blogs">
                <button className="home-learn button" name="button">
                  <span className="home-text15">Learn more</span>
                  <img
                    alt="image"
                    src="../static/img/Icons/arrow-2.svg"
        ...
        <div className="home-content11">
          <div className="home-main2">
            ...
            <a href="/release-slate">
              <button className="home-view1 button1" name="button">Unveil MCU Timeline</button>
            </a>
          </div>
          <img alt="image" src="../static/img/Timeline.png" className="home-image20" />
        </div>
      </section>
      ...
      <section className="home-get-yours">
        <div className="home-row1">
          <div className="home-column">
            <div className="home-card09">
              <img alt="image" src="../static/img/AvengersLogo.png" className="home-image21" />
            </div>
          </div>
          <div className="home-column1">
            <div className="home-card10">
              <img alt="image" src="../static/img/GuardiansLogo.png" className="home-image22" />
            </div>
          </div>
        </div>
        <div className="home-column2">
          <div className="home-card11">
            ...
            <a href="/collaborate">
              <button className="home-button6 button1" value="cardcollabredir" name="button">
...
const domContainer = document.querySelector('#home-page-container');
